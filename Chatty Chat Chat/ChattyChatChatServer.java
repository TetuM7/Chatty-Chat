...
public class ChattyChatChatServer {
	public static void main(String[] args) {
	    ...
	    Vector<ChattyChatChatServerRunnable> clientlist = new Vector<ChattyChatChatServerRunnable>();
	...
	": " + client);
	          ChattyChatChatServerRunnable r = new ChattyChatChatServerRunnable(clientNumber, 
	client, clientlist);
	         clientlist.add(r);
